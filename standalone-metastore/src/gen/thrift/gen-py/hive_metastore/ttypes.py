      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i668 in xrange(_size664):
            _elem669 = FieldSchema()
            _elem669.read(iprot)
            self.cols.append(_elem669)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 5:
...
class FindSchemasByColsResp:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i675 in xrange(_size671):
            _elem676 = FindSchemasByColsRespEntry()
            _elem676.read(iprot)
            self.schemaVersions.append(_elem676)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.schemaVersions is not None:
      ...
      for iter677 in self.schemaVersions:
        iter677.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
