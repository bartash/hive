      ...
      switch ($fid)
      {
        ...
        case 4:
          if ($ftype == TType::LST) {
            ...
            {
              $elem671 = null;
              $elem671 = new \metastore\FieldSchema();
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::LST) {
            ...
            {
              $elem678 = null;
              $elem678 = new \metastore\FindSchemasByColsRespEntry();
              $xfer += $elem678->read($input);
              $this->schemaVersions []= $elem678;
            }
            $xfer += $input->readListEnd();
          } else {
            $xfer += $input->skip($ftype);
  ...
  public function write($output) {
    ...
    if ($this->schemaVersions !== null) {
      ...
      $xfer += $output->writeFieldBegin('schemaVersions', TType::LST, 1);
      {
        ...
        {
          foreach ($this->schemaVersions as $iter679)
          {
