            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.cols = new ArrayList<FieldSchema>(_list754.size);
                FieldSchema _elem755;
                for (int _i756 = 0; _i756 < _list754.size; ++_i756)
                {
                  _elem755 = new FieldSchema();
                  _elem755.read(iprot);
                  struct.cols.add(_elem755);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, SchemaVersion struct) throws org.apache.thrift.TException {
      ...
      if (struct.cols != null) {
        oprot.writeFieldBegin(COLS_FIELD_DESC);
        {
          ...
          for (FieldSchema _iter757 : struct.cols)
          {
      ...
      if (struct.isSetCols()) {
        {
          ...
          for (FieldSchema _iter758 : struct.cols)
          {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.cols = new ArrayList<FieldSchema>(_list759.size);
          FieldSchema _elem760;
          for (int _i761 = 0; _i761 < _list759.size; ++_i761)
          {
            _elem760 = new FieldSchema();
            _elem760.read(iprot);
            struct.cols.add(_elem760);
          }
        }
        struct.setColsIsSet(true);
      }
