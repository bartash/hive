            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.schemaVersions = new ArrayList<FindSchemasByColsRespEntry>(_list762.size);
                FindSchemasByColsRespEntry _elem763;
                for (int _i764 = 0; _i764 < _list762.size; ++_i764)
                {
                  _elem763 = new FindSchemasByColsRespEntry();
                  _elem763.read(iprot);
                  struct.schemaVersions.add(_elem763);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, FindSchemasByColsResp struct) throws org.apache.thrift.TException {
      ...
      if (struct.schemaVersions != null) {
        oprot.writeFieldBegin(SCHEMA_VERSIONS_FIELD_DESC);
        {
          ...
          for (FindSchemasByColsRespEntry _iter765 : struct.schemaVersions)
          {
      ...
      if (struct.isSetSchemaVersions()) {
        {
          ...
          for (FindSchemasByColsRespEntry _iter766 : struct.schemaVersions)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.schemaVersions = new ArrayList<FindSchemasByColsRespEntry>(_list767.size);
          FindSchemasByColsRespEntry _elem768;
          for (int _i769 = 0; _i769 < _list767.size; ++_i769)
          {
            _elem768 = new FindSchemasByColsRespEntry();
            _elem768.read(iprot);
            struct.schemaVersions.add(_elem768);
          }
        }
        struct.setSchemaVersionsIsSet(true);
      }
